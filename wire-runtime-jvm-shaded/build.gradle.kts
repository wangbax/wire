...
val shadowedRuntime by configurations.creating {
...
dependencies {
  add(shadowedRuntime.name, project(":wire-runtime"))
  add(shadowedRuntime.name, libs.okio.core)
...
shadowJarTask.configure {
  ...
  configurations = listOf(shadowedRuntime)
